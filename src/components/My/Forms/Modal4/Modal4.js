...
export default function StudentForm({ values, errors, touched, setFieldValue, handleSubmit, handleBlur, isSubmitting }) {
  return (
    <form onSubmit={handleSubmit} className="modal4_form">
      <div className="modal4_form-subhead">Ввод дисциплины</div>
      <div className="discipline-textarea">
        <textarea
          name="discipline"
          id="discipline"
          placeholder="Введите для поиска название дисциплины"
      ...
      <div className="modal4_form-titlediscipl">
        <Input
          name="titlediscipl"
          id="titlediscipl"
          placeholder="Введите аннотацию к курсу"
      ...
      <div className="descrdiscipl-textarea">
        <textarea
          name="descrdiscipl"
          id="descrdiscipl"
          placeholder="Введите краткое описание дисциплины для отбражения в профиле на вашей странице"
      ...
      <div className="text-center discipline-button">
        <Button className="button button_modalblue">Создать</Button>
      </div>
    </form>
  );
}
