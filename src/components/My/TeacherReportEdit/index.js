    ...
    <div className="table-responsive">
      ...
      <GridRow>
        ...
        <GridCol width={{ mobile: 1, tablet: 1, desktop: 1 }} className="form-field">
          <Link pseudo onClick={() => onReturn()}><img src={Pencil1} alt=""/></Link>
        </GridCol>
      </GridRow>

      <table className="teacherreport-block-table shaded-table">
        <tbody>
