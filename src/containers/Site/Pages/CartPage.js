...
class CartPage extends Component {
  ...
  render()
 {
    ...
    <table style={{ width: '100%' }}>
		...
		<thead>
			<th className="main-sections-heading-name">Название</th>	
			<th className="main-sections-heading-price">Цена</th>				
			<th className="main-sections-heading-quantity">Количество</th>	
			<th className="main-sections-heading">Итого</th>				
		</thead>
		<tfoot>


	        
			<span className="total main-sections-heading" > Всего на сумму:{" "}{this.state.totalPrice}{' '}руб.</span><br />		
		...
		<tbody className="main-sections-description">
