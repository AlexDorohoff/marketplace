...
import { affiliateBreadcrumbs } from '../../../../core/utils/testData';
import Scroll from '../ScrollTotop';
import Footer from '../../../../components/Common/Footer';
import RequestForm from '../../../../components/Site/Forms/RequestForm_reg';
import MainSections from '../Pravila home/TilePravila/Tile_affiliate';

const Experts = () => (
  <>
    <Helmet>
      <meta charSet="utf-8" />
      <title>Море-Партнерская политика</title>
    ...
    <section className="section breadcrumbs">
      <Breadcrumbs items={affiliateBreadcrumbs} />             
      <Scroll />
    </section>
