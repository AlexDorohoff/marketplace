...
import { cookieBreadcrumbs } from '../../../../core/utils/testData';
import Scroll from '../ScrollTotop';
import Footer from '../../../../components/Common/Footer';
import RequestForm from '../../../../components/Site/Forms/RequestForm_reg';
import MainSections from '../Pravila home/TilePravila/Tile_cookie';

const Experts = () => (
  <>
    <Helmet>
      <meta charSet="utf-8" />
      <title>Море-Файлы Cookie  и аналогичные технологии</title>
    ...
    <section className="section breadcrumbs">
      <Breadcrumbs items={cookieBreadcrumbs} />             
      <Scroll />
    </section>
