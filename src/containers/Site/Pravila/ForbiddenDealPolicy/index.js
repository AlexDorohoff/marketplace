...
import { forbidBreadcrumbs } from '../../../../core/utils/testData';
import Scroll from '../ScrollTotop';
import Footer from '../../../../components/Common/Footer';
import RequestForm from '../../../../components/Site/Forms/RequestForm_reg';
import MainSections from '../Pravila home/TilePravila/Tile_forbidden';

const Experts = () => (
  <>
    <Helmet>
      <meta charSet="utf-8" />
      <title>Море-Политика запрещенных сделок</title>
    ...
    <section className="section section_fullwidth1 breadcrumbs">
      <Breadcrumbs items={forbidBreadcrumbs} />             
      <Scroll />
    </section>
