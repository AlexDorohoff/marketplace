...
import { intellectBreadcrumbs } from '../../../../core/utils/testData';
import Scroll from '../ScrollTotop';
import Footer from '../../../../components/Common/Footer';
import RequestForm from '../../../../components/Site/Forms/RequestForm_reg';
import MainSections from '../Pravila home/TilePravila/Tile_intPP';

const Experts = () => (
  <>
    <Helmet>
      <meta charSet="utf-8" />
      <title>Море-Интеллектуальная собственность и политика ресурса</title>
    ...
    <section className="section section_fullwidth1 breadcrumbs">
      <Breadcrumbs items={intellectBreadcrumbs} />             
      <Scroll />
    </section>
