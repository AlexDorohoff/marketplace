...
import { arbitrationBreadcrumbs } from '../../../../core/utils/testData';
import Scroll from '../ScrollTotop';
import Footer from '../../../../components/Common/Footer';
import RequestForm from '../../../../components/Site/Forms/RequestForm_reg';
import MainSections from '../Pravila home/TilePravila/Tile_arbitration';

const Experts = () => (
  <>
    <Helmet>
      <meta charSet="utf-8" />
      <title>Море-Арбитражные правила (Политика разрешения споров)</title>
    ...
    <section className="section breadcrumbs">
      <Breadcrumbs items={arbitrationBreadcrumbs} />             
      <Scroll />
    </section>
